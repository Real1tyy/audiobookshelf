...
module.exports = {
  ...
  /**
   * Get total file size and number of items for books
   *
   * @typedef {Object} SizeObject
   * @property {number} totalSize
   * @property {number} numItems
   *
   * @returns {Promise<{books: SizeObject, total: SizeObject}>}
   */
  async getTotalSize() {
  ...
  /**
   * Get total number of audio files for books
   *
   * @returns {Promise<{numBookAudioFiles: number, numAudioFiles: number}>}
   */
  async getNumAudioFiles() {
    ...
    return {
      numBookAudioFiles,
      numAudioFiles: numBookAudioFiles
    }
  }
}
